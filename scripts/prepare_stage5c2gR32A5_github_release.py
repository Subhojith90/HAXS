...
from stage5c2gR32A5_common import load_candidate, sha256_file, sha256_payload, strict_json
...
def main() -> None:
    ...
    if (
        local_dry_run.get("schema_version") != "haxs.stage5c2gR32A5.local-two-host-dry-run.v1"
    ...
    protocol_dir = ROOT / "output/stage5c2gR32A5"
    release = ROOT / "releases/stage5c2gR32A5"
    reference = ROOT / "ci/frozen/stage5c2gR32A5/reference/HOST_A"
    release.mkdir(parents=True, exist_ok=True)
    for name in ["HAXS_Stage5C2G_R3_2A_5_Protocol.zip", "HAXS_Stage5C2G_R3_2A_5_Protocol_SHA256.txt"]:
        target = release / name
        if target.exists() or target.is_symlink():
            raise RuntimeError(f"refusing to overwrite release object: {target}")
        shutil.copy2(protocol_dir / name, target)
    release_protocol = release / "HAXS_Stage5C2G_R3_2A_5_Protocol.zip"
    ...
    dry_run_target = ROOT / "ci/frozen/stage5c2gR32A5/reference/LOCAL_TWO_HOST_DRY_RUN.json"
    ...
    inputs = [
        ...
        release / "HAXS_Stage5C2G_R3_2A_5_Protocol.zip",
        release / "HAXS_Stage5C2G_R3_2A_5_Protocol_SHA256.txt",
        dry_run_target,
    ]
    ...
    manifest = ROOT / "ci/frozen/stage5c2gR32A5/INPUT_MANIFEST_SHA256.txt"
    ...
    print(json.dumps({
        "stage": "Stage5C2G-R3.2A.5", "status": "PASS",
        "candidate_sha256": candidate["candidate_sha256"],
        "protocol_archive_sha256": sha256_file(release / "HAXS_Stage5C2G_R3_2A_5_Protocol.zip"),
