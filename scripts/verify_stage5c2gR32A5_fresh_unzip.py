...
from stage5c2gR32A5_common import load_candidate, sha256_file
...
def verify_protocol(protocol: Path) -> dict:
    with zipfile.ZipFile(protocol) as archive:
        ...
        with tempfile.TemporaryDirectory(prefix="haxs-stage5c2gR32A5-fresh-") as directory:
            ...
            return {
                "stage": "stage5c2gR32A5_fresh_unzip", "status": "PASS",
