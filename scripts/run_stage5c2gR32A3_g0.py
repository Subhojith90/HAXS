...
from stage5c2gR32A3_semantics import COMMAND_SCHEMA, normalized_argv, verify_junit_semantics
...
def clean_environment() -> dict[str, str]:
    ...
    environment.update({
        ...
        "PYTHONPYCACHEPREFIX": os.environ["HAXS_R32A3_G0_PYCACHE"],
...
def run_recorded(
    ...
    record = {
        ...
        "argv_template": normalized_argv(
            command, str(junit_path) if junit_path is not None else None
        ),
...
def main() -> None:
    ...
    os.environ["HAXS_R32A3_G0_PYCACHE"] = str(external_pycache)
    ...
    commands = [
        (
            [sys.executable, "-I", "-B", "-m", "compileall", "-q", "src", "scripts", "scripts_patch", "tests"],
