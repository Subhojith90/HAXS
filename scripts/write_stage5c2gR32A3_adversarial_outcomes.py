...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=ROOT / "results/stage5c2gR32A3/adversarial/OUTCOMES.json")
    args = parser.parse_args()
    if args.out.exists() or args.out.is_symlink():
        raise RuntimeError("refusing to overwrite R3.2A.3 outcomes")
    definition_path = ROOT / "configs/stage5c2gR32A3/adversarial_fixture_ledger.json"
    ...
    payload = {
        "schema_version": "haxs.stage5c2gR32A3.adversarial-outcomes.v1",
