...
from stage5c2gR32A5_common import atomic_write_json, sha256_payload

SUITES = {
    "full": ["tests"],
    "targeted": [
        "tests/stage5c2gR32A5", "tests/stage5c2gR32A4", "tests/stage5c2gR32A3", "tests/stage5c2gR32A2",
...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=ROOT / "results/stage5c2gR32A5/protocol/NAMED_TEST_LEDGER.json")
    args = parser.parse_args()
    if args.out.exists() or args.out.is_symlink():
        raise RuntimeError("refusing to overwrite R3.2A.5 named-test ledger")
    ...
    payload = {
        "schema_version": "haxs.stage5c2gR32A5.named-tests.v1",
