...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=ROOT / "results/stage5c2gR32A3/protocol/ROOT_MANIFEST.json")
    args = parser.parse_args()
    if args.out.exists() or args.out.is_symlink():
        raise RuntimeError("refusing to overwrite R3.2A.3 root manifest")
    ledger = ROOT / "results/stage5c2gR32A3/protocol/NAMED_TEST_LEDGER.json"
    paths = runtime_paths()
    ...
    payload = {
        "schema_version": "haxs.stage5c2gR32A3.root-manifest.v1",
