...
from build_stage5c2gR32A5_candidate import closure_paths, runtime_paths
from stage5c2gR32A5_common import safe_relative, sha256_file

PREFIX = "HAXS_Stage5C2G_R3_2A_5_Protocol"
...
def main() -> None:
    output = ROOT / "output/stage5c2gR32A5"
    output.mkdir(parents=True, exist_ok=True)
    required = [
        ROOT / "results/stage5c2gR32A5/protocol/CANDIDATE.json",
        ROOT / "results/stage5c2gR32A5/protocol/NAMED_TEST_LEDGER.json",
        ROOT / "results/stage5c2gR32A5/protocol/IMMUTABLE_ROOT_MANIFEST.json",
        ROOT / "results/stage5c2gR32A5/environment.json",
        ROOT / "results/stage5c2gR32A5/adversarial/OUTCOMES.json",
        ROOT / "output/stage5c2gR32A5/haxs-0.8.8-py3-none-any.whl",
    ]
    ...
    if archive.exists() or sidecar.exists():
        raise RuntimeError("refusing to overwrite R3.2A.5 protocol")
    ...
    print(json.dumps({"stage": "stage5c2gR32A5_protocol", "status": "PASS", "archive": str(archive), "sha256": digest, "content_files": len(unique), "G1_authorized": False, "scientific_execution_performed": False}, indent=2, sort_keys=True))
