...
CANDIDATE_PATH = ROOT / "results/stage5c2gR32A4/protocol/CANDIDATE.json"
ROOT_MANIFEST_PATH = ROOT / "results/stage5c2gR32A4/protocol/ROOT_MANIFEST.json"
LOCK_PATH = ROOT / "results/stage5c2gR32A4/protocol/LOCKED.json"
RECEIPT_PATH = ROOT / "results/stage5c2gR32A4/protocol/SUPERVISOR_AUTHORIZATION_G1_ONLY.json"
AUTHORIZATION_PATH = ROOT / "results/stage5c2gR32A4/protocol/AUTHORIZATION.json"
STATE_PATH = ROOT / "results/stage5c2gR32A4/state/G1.json"
SETUP_STATE_PATH = ROOT / "results/stage5c2gR32A4/preflight/SETUP.json"
...
def load_candidate(root: Path = ROOT) -> dict:
    ...
    if candidate.get("schema_version") != "haxs.stage5c2gR32A4.candidate.v1":
    ...
    if candidate.get("candidate_sha256") != sha256_payload(canonical):
        raise RuntimeError("R3.2A.4 candidate self-identity failed")
    return candidate
...
def reserve_attempt(candidate: dict, authorization: dict, root: Path = ROOT) -> dict:
    ...
    artifact = root / "results/stage5c2gR32A4/artifacts" / candidate["candidate_sha256"] / "G1" / attempt_id
    running = {
        "schema_version": "haxs.stage5c2gR32A4.single-attempt-state.v1",
