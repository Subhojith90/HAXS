...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=ROOT / "results/stage5c2gR32A4/protocol/CANDIDATE.json")
    args = parser.parse_args()
    if args.out.exists() or args.out.is_symlink():
        raise RuntimeError("refusing to overwrite R3.2A.4 candidate")
    wheel = ROOT / "output/stage5c2gR32A4/haxs-0.8.7-py3-none-any.whl"
    environment = ROOT / "results/stage5c2gR32A4/environment.json"
    contracts = {
        "receipt_template": ROOT / "configs/stage5c2gR32A4/structured_receipt_template.json",
        "finalizer": ROOT / "scripts/finalize_stage5c2gR32A4_authorization.py",
        "comparator": ROOT / "scripts/compare_stage5c2gR32A4_g0_hosts.py",
        "root_verifier": ROOT / "scripts/verify_stage5c2gR32A4_root.py",
        "environment_verifier": ROOT / "scripts/verify_stage5c2gR32A4_environment.py",
        "launcher": ROOT / "scripts/launch_stage5c2gR32A4_G1_isolated.py",
        "runner": ROOT / "scripts/run_stage5c2gR32A4_G1.py",
        ...
        "test_ledger": ROOT / "results/stage5c2gR32A4/protocol/NAMED_TEST_LEDGER.json",
        "adversarial_outcomes": ROOT / "results/stage5c2gR32A4/adversarial/OUTCOMES.json",
        "root_manifest": ROOT / "results/stage5c2gR32A4/protocol/ROOT_MANIFEST.json",
        "supersession_ledger": ROOT / "configs/stage5c2gR32A4/supersession.json",
        "production_semantics": ROOT / "scripts/stage5c2gR32A4_semantics.py",
        "production_g0_writer": ROOT / "scripts/run_stage5c2gR32A4_g0.py",
        "host_b_release_packager": ROOT / "scripts/package_stage5c2gR32A4_host_b_release.py",
        "complete_return_packager": ROOT / "scripts/package_stage5c2gR32A4_supervisor_return.py",
        "local_two_host_dry_run": ROOT / "scripts/dry_run_stage5c2gR32A4_complete_return.py",
        "engineering_acceptance_contract": ROOT / "docs/stage5c2gR32A4/ACCEPTANCE_CONTRACT.md",
        "authoritative_runbook": ROOT / "docs/stage5c2gR32A4/STAGE5C2GR32A4_RUNBOOK.md",
        "failure_boundary_protocol": ROOT / "docs/stage5c3VB/PROTOCOL.md",
        "failure_boundary_config": ROOT / "configs/stage5c3VB/protocol.yaml",
        "host_b_workflow": ROOT / ".github/workflows/stage5c2gR32A4-host-b-g0.yml",
        "host_b_runner": ROOT / "ci/run_stage5c2gR32A4_github_host_b_g0.sh",
    }
    ...
    if any(not path.is_file() or path.is_symlink() for path in required):
        raise RuntimeError("R3.2A.4 candidate input is missing or unsafe")
    ...
    payload = {
        "schema_version": "haxs.stage5c2gR32A4.candidate.v1",
        "stage": "stage5c2gR32A4",
        "predecessor_candidate_sha256": "03e02b4bc98a5fd116442b8453d8cf2f533c5f66c36a5b7868045d91b320f528",
        "predecessor_disposition": "PRESERVED_STATIC_REPAIR_REJECTED_FOR_PRODUCTION_G0",
        ...
        "scope": {
            "scientific_G1_design": "UNCHANGED_FROM_R3_2A_3",
