...
from stage5c2gR32A4_semantics import COMMAND_SCHEMA, normalized_argv, verify_junit_semantics
...
def clean_environment() -> dict[str, str]:
    ...
    environment.update({
        ...
        "PYTHONPYCACHEPREFIX": os.environ["HAXS_R32A4_G0_PYCACHE"],
...
def main() -> None:
    ...
    os.environ["HAXS_R32A4_G0_PYCACHE"] = str(external_pycache)
    ...
    payload = {
        "schema_version": "haxs.stage5c2gR32A4.physical-host-g0.v1",
