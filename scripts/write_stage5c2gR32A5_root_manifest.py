...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=ROOT / "results/stage5c2gR32A5/protocol/IMMUTABLE_ROOT_MANIFEST.json")
    args = parser.parse_args()
    if args.out.exists() or args.out.is_symlink():
        raise RuntimeError("refusing to overwrite R3.2A.5 root manifest")
    ledger = ROOT / "results/stage5c2gR32A5/protocol/NAMED_TEST_LEDGER.json"
    paths = runtime_paths()
    ...
    payload = {
        "schema_version": "haxs.stage5c2gR32A5.immutable-root.v1",
        "policy": "immutable_whole_root_deny_by_default_v1",
        ...
        "mutable_control_objects_inside_root_permitted": False,
