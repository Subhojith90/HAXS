...
PREFIX = "HAXS_Stage5C2G_R3_2A_5_Complete_G0_Return"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="haxs-stage5c2gR32A5-return-") as directory:
        ...
        record = {
            "schema_version": "haxs.stage5c2gR32A5.complete-g0-return.v1",
    ...
    print(json.dumps({
        "stage": "stage5c2gR32A5_complete_g0_return", "status": "PASS",
