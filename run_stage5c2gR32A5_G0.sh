...
: "${HAXS_R32A5_PYTHON:?HAXS_R32A5_PYTHON must be exact isolated CPython 3.12.7}"

REPOSITORY_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROTOCOL="${HAXS_PROTOCOL_ARCHIVE:-$REPOSITORY_ROOT/output/stage5c2gR32A5/HAXS_Stage5C2G_R3_2A_5_Protocol.zip}"
SIDECAR="${HAXS_PROTOCOL_SIDECAR:-$REPOSITORY_ROOT/output/stage5c2gR32A5/HAXS_Stage5C2G_R3_2A_5_Protocol_SHA256.txt}"
RUN="$HAXS_RUN_ROOT"
ROOT="$RUN/protocol/HAXS_Stage5C2G_R3_2A_5_Protocol"
...
cd "$ROOT"
"$HAXS_R32A5_PYTHON" -I -B scripts/run_stage5c2gR32A5_g0.py \
